//
//  TutorialCollectionDataSource.swift
//  Tutorial
//
...
final class TutorialCollectionDataSource: NSObject, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    private func set(collectionView: UICollectionView) {
        ...
        collectionView.registerNib(TutorialCollectionViewCell.self)
    ...
    func collectionView(
        ...
        guard let cell = collectionView.dequeue(TutorialCollectionViewCell.self, for: indexPath) else {
